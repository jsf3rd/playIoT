...
function MV_CC_RotateImage(Var handle: Pointer; pstRotateParam: PMV_CC_ROTATE_IMAGE_PARAM):Integer; stdcall; external 'MvCameraControl.dll';
function MV_CC_FlipImage(Var handle: Pointer; pstFlipParam: PMV_CC_FLIP_IMAGE_PARAM):Integer; stdcall; external 'MvCameraControl.dll';
